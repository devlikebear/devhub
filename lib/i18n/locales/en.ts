...
Quickly draft your Markdown with DevHub!`,
    ...
    qrPage: {
      ...
      subtitle: 'Convert text or URL to QR code',
      labels: {
        input: 'Text or URL to Convert',
      ...
      placeholders: {
        input: 'Enter https://example.com or any text to convert',
      },
      messages: {
    ...
    cronPage: {
      ...
      subtitle: 'Generate cron expressions and preview next execution times',
      labels: {
      ...
      templates: {
        ...
        everyMonth: 'Every 1st of month at midnight',
        everyYear: 'Every January 1st at midnight',
        weekdays9am: 'Weekdays at 9 AM',
        weekdays6pm: 'Weekdays at 6 PM',
        every15min: 'Every 15 minutes',
        every30min: 'Every 30 minutes',
        everyMorning: 'Every day at 8 AM',
        everyEvening: 'Every day at 8 PM',
      },
      fieldNames: {
        minute: 'Minute',
        hour: 'Hour',
      ...
      specialChars: {
        ...
        hyphen: {
          symbol: '-',
          description: 'Range',
          example: '0 9-17 * * * = Every hour from 9 to 17',
        },
        slash: {
          symbol: '/',
    ...
    imagePage: {
      ...
      subtitle: 'Convert image formats and resize with ease',
      labels: {
        upload: 'Upload Image',
      ...
      info: {
        ...
        acceptedFormats: 'Supported: PNG, JPEG, WebP, GIF',
    ...
    loremPage: {
      ...
      subtitle: 'Generate dummy text for layout testing',
      labels: {
        count: 'Count',
        unit: 'Unit',
        options: 'Options',
